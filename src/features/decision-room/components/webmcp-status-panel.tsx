...
export function WebMcpStatusPanel({
  ...
  return (
    <Card id="agent-flight-recorder" className="overflow-hidden rounded-lg border-primary/25 bg-card py-4 shadow-sm">
      <CardHeader className="gap-2 px-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <div className="flex items-center gap-2">
              <Workflow aria-hidden="true" className="size-4 text-primary" />
              <h2 className="text-base font-semibold">Agent Flight Recorder</h2>
              <span
      ...
      <CardContent className="grid gap-4 px-4">
        ...
        >
          ...
          <div aria-label="Human authority: protected" className="flight-capability-node col-span-2 rounded-lg border border-dashed border-primary/30 bg-primary/5 p-2.5 sm:col-span-1">
